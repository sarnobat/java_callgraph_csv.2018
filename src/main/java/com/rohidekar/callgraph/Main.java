...
public class Main {
  ...
  // EmployeeAssembler
  // TODO(testing): make printGraphs return a string buffer so you can do
  // assertions in unit tests

  // TODO: Create a configuration object. Have several profiles: automatic,
  // maximal
  ...
  private static void printGraphs(String resource) {
    ...
    // RootFinder.findRootCallers(allMethodNamesToMethodNodes);
    ...
    // Set<GraphNode> rootMethodNodes =
    // RootFinder.findRoots(allPacakgeNamesToPackageNodes);
    // if (log.isEnabledFor(Level.DEBUG)) {
    // log.debug("Root package: " +
    // rootMethodNodes.iterator().next().toString());
    // }
